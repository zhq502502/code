...
public class PayCommonUtil {
	...
	public static String CreateNonceYURREF() {
	...
	public static String CreateNoncePayYURREF() {
		String chars = "0123456789";
		String res = "";
		for (int i = 0; i < 10; i++) {
			Random rd = new Random();
	...
	public static Boolean checkSign(String characterEncoding,SortedMap<Object,Object> parameters,String apiKey){
		StringBuffer sb = new StringBuffer();
		Set es = parameters.entrySet();
		Iterator it = es.iterator();
		String sign2 = "";
	...
	public static String getRequestXml(SortedMap<Object,Object> parameters){
		...
		while(it.hasNext()) {
			...
			if ("return_code".equalsIgnoreCase(k)||"return_msg".equalsIgnoreCase(k)) {
