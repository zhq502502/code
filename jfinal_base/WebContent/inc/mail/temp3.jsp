...
.label-9{ font-size: 15px; font-weight:bold; color: #396584;padding-right:10px;}
.text-5 { font-size:15px; color:#C01E54; font-weight:bold; font-style:italic; font-family: "Times New Roman",Helvetica,sans-serif;}
...
<div id='wrap'>
	...
	<div id='content'>
		<div class='container' style='margin-top:10px;'>
			<span class='content-maintitle'>尾款通知函</span><span class='content-subtitle'>付款将在1-3天内到达,取决于银行支付交换系统</span>
		</div>
		<div class='container'>
			<hr class='hr-red' />
		</div>
		...
		<div class='container'>
			<span class='label-9'>该项目已于 <%=request.getParameter("prepaydate") %>支付预付款，金额:</span><span class='text-5'><%=request.getParameter("subsist") %></span>
		</div>
		<div class='container' style='margin-top:20px;'>
			<span class='label-9'>尾款增减金额:</span><span class='text-5'><%=request.getParameter("overage") %></span>
		</div>
		<div class='container' style='margin-top:10px; margin-bottom:20px;'>
			<span class='label-2'>尾款金额:</span><span class='text-2'><%=request.getParameter("last") %></span>
		</div>
		...
		<div class='container' style='margin-bottom:5px;'>
			<span class='label-4'>采购申请人:</span><span class='text-3'><%=request.getParameter("user1") %></span><span class='text-4'><%=request.getParameter("phone1") %></span>
		</div>
		<div class='container'>
