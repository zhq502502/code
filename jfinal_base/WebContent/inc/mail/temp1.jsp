...
#content { margin: 0 25px !important;  min-height:400px;}
...
<div id='wrap'>
	...
	<div id='content'>
		<div class='container' style='margin-top:10px !important;'>
			<span class='content-maintitle'>订单流转通知函</span><span class='content-subtitle'>非付款通知函</span>
		</div>
		<div class='container'>
			<hr class='hr-red' />
		</div>
		...
		<div class='container'>
			<span class='mail-body'>一封重要的邮件, 包含重要的PO信息，合规/供应商须知等。</span>
		</div>
		<div class='container' style='margin:30px 0 !important;'>
			<hr class='hr-gray-dashed' />
		</div>
		<div class='container'>
			<span class='label-1'>项目:</span><span class='text-1'><%=request.getParameter("pjname") %></span>
		</div>
		<div class='container' style='margin-top:10px !important; margin-bottom:30px !important;'>
			<span class='label-1'>客户:</span><span class='text-1'><%=request.getParameter("customer") %></span>
		</div>
		<div class='container'>
			<span class='label-2'>最终采购一口价:</span><span class='text-2'><%=request.getParameter("price") %></span>
		</div>
		<div class='container' style='margin-top:10px !important; margin-bottom:30px !important;'>
		...
		<div class='container' style='margin-top:20px !important; margin-bottom:5px !important;'>
		...
		<div class='container' style='margin-bottom:5px !important;'>
			<span class='label-4'>采购申请人:</span><span class='text-3'><%=request.getParameter("user2") %></span><span class='text-4'><%=request.getParameter("phone2") %></span>
		</div>
		<div class='container'>
			<span class='label-4'>投诉电话:</span><span class='text-3'>运营部</span><span class='text-4'>021-59698756</span>
		</div>
		<div class='container' style='margin:20px 0 10px 0 !important;'>
			<hr class='hr-gray' />
		</div>
		<div class='container'>
			<div style='margin:0 auto; width:281px !important;'><span><img src='cid:wink' /></span></div>
		</div>
	</div>
