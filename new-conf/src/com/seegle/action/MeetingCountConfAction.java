...
public class MeetingCountConfAction extends org.apache.struts.action.Action {
...
//    	SeegleLog.getInstance().getLog(this.getClass(), session.getAttribute("orgid").toString()).debug("debug in MeetingCountConfAction");
        ...
        ccList = cco.getConfLogInfo(token.toString(), begintime, endtime, firstIndex, showNumber);
        request.setAttribute("ccList", ccList);
        int maxNumber = cco.getConfLogCount(token.toString(), begintime, endtime);
