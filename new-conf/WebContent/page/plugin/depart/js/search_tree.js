/**
	...
	function highlightAndExpand_ztree(treeId, highlightNodes, flag){
		...
		if (highlightNodes != null) {
			...
			treeObj.selectNode({},false);
			console.log(highlightNodes.length);
			for (var i = 0; i < highlightNodes.length; i++) {
				//treeObj.expandNode(highlightNodes[i], true, true, true);
				...
				treeObj.expandNode(parentNodes, true, true, true);
