...
Seegle = {
	 ...
	 * @vn vissName 用户名
	 * @vp vissPassword 密码
	 * @vc vissCamList 摄像头列表，每个摄像头以_分开。
	 * 
	 */
	startconf: function(i, j, k, q, w, n, updateserverset, logintype, regpath, regkey, exename,ptype,paddr,pport,puser,ppass,vi,vn,vp,vc)
	{
	    ...
	    +" -vissIpPort "+vi+" -vissName \"$"+vn+"\" -vissPassword \"$"+vp+"\" -vissCamList \"" +vc+"\" "+"?/";
	    url = url + confpara;
		this.log(url);
